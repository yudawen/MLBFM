...
class Debugger(object):
  def __init__(self, ipynb=False, theme='black', 
    ...
    if dataset == 'coco_hp':
      ...
      self.names = pylon_class_name
    elif dataset == 'u3d':
      self.names = u3d_class_name
    elif num_classes == 20 or dataset == 'dior':
      self.names = dior_class_name
    elif  dataset == 'building':
        self.names=building_class_name
    elif dataset == 'tzb':
        self.names=tzb_class_name
    elif num_classes == 10 or dataset == 'NWPU':
      self.names = nwpu_class_name
    elif num_classes == 4 or dataset == 'ROSD':
      self.names = rosd_class_name
...
pylon_class_name=['pylon']
u3d_class_name=['building']
# dior_class_name=['airport','stadium','trainstation']
dior_class_name = ['airplane', 'airport', 'baseballfield', 'basketballcourt', 'bridge', 'chimney', 'dam',
...
tzb_class_name=['bigship']
rosd_class_name=['aircraft','oiltank','overpass','playground']
nwpu_class_name=['airplane', 'ship', 'storage-tank', 'baseball-diamond', 'tennis-court', 'basketball-court', 'ground-track-field', 'harbor', 'bridge', 'vehicle']
